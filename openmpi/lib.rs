...
impl MPI_Datatype {
  pub fn UNSIGNED_CHAR() -> MPI_Datatype {
    unsafe { MPI_Datatype(transmute(&ompi_mpi_unsigned_char)) }
  }

  pub fn BYTE() -> MPI_Datatype {
    unsafe { MPI_Datatype(transmute(&ompi_mpi_byte)) }
  }

  pub fn UNSIGNED_LONG_LONG() -> MPI_Datatype {
    unsafe { MPI_Datatype(transmute(&ompi_mpi_unsigned_long_long)) }
  }

  pub fn FLOAT() -> MPI_Datatype {
    unsafe { MPI_Datatype(transmute(&ompi_mpi_float)) }
  }

  pub fn DOUBLE() -> MPI_Datatype {
    unsafe { MPI_Datatype(transmute(&ompi_mpi_double)) }
  }
}
...
impl MPI_Info {
  pub fn NULL() -> MPI_Info {
    unsafe { MPI_Info(transmute(&ompi_mpi_info_null)) }
  }
}
...
impl MPI_Op {
  pub fn SUM() -> MPI_Op {
    unsafe { MPI_Op(transmute(&ompi_mpi_op_sum)) }
  }
}
...
impl MPI_Request {
  pub fn NULL() -> MPI_Request {
    unsafe { MPI_Request(transmute(&ompi_request_null)) }
  }
}
...
impl MPI_Win {
  pub fn NULL() -> MPI_Win {
    unsafe { MPI_Win(transmute(&ompi_mpi_win_null)) }
  }
}
